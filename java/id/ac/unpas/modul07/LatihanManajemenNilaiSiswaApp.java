 ...
 * @author riyya
 */
public class LatihanManajemenNilaiSiswaApp extends JFrame {
    ...
    // Konstruktor
    public LatihanManajemenNilaiSiswaApp() {
    ...
    private JPanel createInputPanel() {
        ...
        panel.add(new JLabel("")); // placeholder agar tombol di kanan bawah
        panel.add(btnSimpan);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new LatihanManajemenNilaiSiswaApp().setVisible(true);
        });
    }
